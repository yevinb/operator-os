...
import { Zap, Send, AlertCircle, Target } from "lucide-react";
...
export default function CommandCenterPage() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-6xl mx-auto space-y-6">
      <Link
        href="/dashboard"
        className="block p-4 rounded-2xl border border-gold/30 bg-gold/10 text-sm text-gold hover:bg-gold/15 transition-colors"
      >
        💬 Prefer chatting? Open <strong>Nexa Chat</strong> — talk naturally and I&apos;ll execute outcomes live.
      </Link>
